        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            <p className="text-text-secondary leading-relaxed">
              ...
              exactly how every supplement and habit affected his body. Not what
              a brand claimed. Not what an influencer promoted. What actually
              worked, for him, backed by real data.
            </p>
            <p className="text-text-secondary leading-relaxed">
              Connor is studying naturopathic medicine and kept seeing patients
              confused by contradictory advice with no way to track what was
              actually helping.
            </p>
            <p className="text-text-secondary leading-relaxed">
              ...
              watches what you take and do, tracks how you respond, and tells you
              the truth.
            </p>
            <p className="text-text-primary font-semibold text-lg leading-relaxed">
              ...
              two brothers who are passionate about their health and were tired
              of guessing.
            </p>
          </div>
        </div>
