  ...
  try {
    ...
    return NextResponse.json({
      ...
      drafts: drafts.map((draft) => ({
        ...
        smsTestedAt: draft.sms_tested_at || null,
        smsTestVersion: draft.sms_test_version || 0,
        smsTestRecipientMasked: draft.sms_test_recipient_masked || null,
        smsTestMessageSid: draft.sms_test_message_sid || null,
        smsTestProviderStatus: draft.sms_test_provider_status || null,
        smsTestSenderMasked: draft.sms_test_sender_masked || null,
        smsTestStatus: draft.sms_test_status || null,
        smsTestTransport: draft.sms_test_transport || null,
