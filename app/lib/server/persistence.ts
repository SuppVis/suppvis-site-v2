...
export type EmailCampaignRecord = {
  ...
  sms_test_sender_masked?: string | null;
  sms_test_status?: string | null;
  sms_test_transport?: string | null;
...
function emailCampaignFromAttributes(
  ...
  return {
    ...
    sms_test_sender_masked:
      nullableStringAttribute(attributes?.sms_test_sender_masked) || null,
    sms_test_status:
      nullableStringAttribute(attributes?.sms_test_status) || null,
    sms_test_transport:
      nullableStringAttribute(attributes?.sms_test_transport) || null,
    sms_test_attempt_id:
...
function emailCampaignSummary(record: EmailCampaignRecord): EmailCampaignSummary {
  return {
    ...
    sms_test_sender_masked: record.sms_test_sender_masked,
    sms_test_status: record.sms_test_status,
    sms_test_transport: record.sms_test_transport,
...
export async function updateEmailCampaignSmsDraft(input: {
  ...
  const result = await updateDynamoItem({
    ...
    set: {
      ...
      sms_test_sender_masked: null,
      sms_test_status: null,
      sms_test_transport: null,
...
export async function markEmailCampaignSmsTestSent(input: {
  ...
  const result = await updateDynamoItem({
    ...
    set: {
      ...
      sms_test_sender_masked: input.sender_masked,
